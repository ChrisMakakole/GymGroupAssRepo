    ...
    <div class="members-container">
        ...
        <div class="help-card">
            ...
            <div class="help-options">
                ...
                <div class="help-option">
                    <div class="help-option-title">You can view existing members from the below button</div>
                    <div class="help-option-desc">Check members and all their details</div>
                    <button class="btn btn-primary" onclick="loadContent('view_members.jsp')">VIEW MEMBERS</button>
                </div>
            </div>
        </div>
    </div>
