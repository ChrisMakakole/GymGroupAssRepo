...
<div class="container">
  ...
  <div class="add-button-container">
    <button class="add-button" onclick="loadContent('admin/add_package.jsp')">Add New Package</button>
  </div>
...
<%--        <a href="${pageContext.request.contextPath}/admin/packages?action=edit&id=<%= pkg.getId() %>" class="edit-button">Edit</a>--%>
        <button class="edit-button" onclick="loadContent('admin/packages?action=edit&id=<%= pkg.getId() %>')">Edit</button>
